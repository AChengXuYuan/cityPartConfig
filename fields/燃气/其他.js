...
buildForm(rqqt, 'UPNetwork_RQ_QT_Point', '燃气其它')
buildTable(rqqt, 'UPNetwork_RQ_QT_Point', '燃气其它')
buildSimpleSearch(rqqt, 'UPNetwork_RQ_QT_Point', '燃气其它')
buildAdvanceSearch(rqqt, 'UPNetwork_RQ_QT_Point', '燃气其它')