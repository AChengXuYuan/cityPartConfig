...
buildForm(psgx, 'UPNetwork_YS_Tubulation', '排水管线')
buildTable(psgx, 'UPNetwork_YS_Tubulation', '排水管线')
buildSimpleSearch(psgx, 'UPNetwork_YS_Tubulation', '排水管线')
buildAdvanceSearch(psgx, 'UPNetwork_YS_Tubulation', '排水管线')